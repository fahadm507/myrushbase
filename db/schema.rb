...
ActiveRecord::Schema.define(version: 20140831152424) do
  ...
  create_table "groupfollowers", force: true do |t|
  ...
  add_index "points", ["user_id", "id"], name: "index_points_on_user_id_and_id", unique: true, using: :btree
  ...
  add_index "subjects", ["user_id", "id"], name: "index_subjects_on_user_id_and_id", using: :btree
